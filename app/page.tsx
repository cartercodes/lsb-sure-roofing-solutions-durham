...
const services = [
  { title: 'Roof Replacement', desc: 'From aging asphalt shingles to full tear-offs, we deliver complete roof replacements built to handle Durham\'s humid summers and unpredictable storm seasons. Your home deserves protection that lasts decades, not just years.', icon: serviceIcons[0] },
  { title: 'Storm Damage Repair', desc: 'When Triangle storms leave their mark, Sure Roofing Solutions responds fast. We handle insurance claims and emergency repairs so your Durham home is secure before the next front rolls through.', icon: serviceIcons[1] },
  { title: 'Roof Inspections', desc: 'Catch small problems before they become costly disasters. Our detailed inspections give Durham homeowners an honest assessment of their roof\'s condition with zero pressure and zero surprises.', icon: serviceIcons[2] },
  { title: 'Gutter Installation', desc: 'Properly installed gutters protect your foundation, siding, and landscaping from North Carolina\'s heavy rainfall. We custom-fit seamless gutter systems to your roofline for maximum performance.', icon: serviceIcons[3] },
  { title: 'Commercial Roofing', desc: 'Durham businesses trust us with flat roofs, TPO, EPDM, and metal systems that stand up to year-round weather demands. Minimal disruption to your operations, maximum protection for your investment.', icon: serviceIcons[4] },
  { title: 'Emergency Leak Repair', desc: 'A leaking roof cannot wait. Our Durham-based crew is ready to respond quickly, locate the source, and stop the damage before it spreads to your ceilings, walls, and belongings.', icon: serviceIcons[5] },
];

const trustItems = [
  'Trusted by 800+ Durham Homeowners',
  'Licensed, Bonded & Insured in North Carolina',
  '5-Star Rated Across Google & the BBB',
        ...
        <div className="about-inner">
          ...
          <div className="about-content">
            ...
            <p className="about-text" data-animate data-delay="2">
              {'Sure Roofing Solutions was built on a simple idea: Durham homeowners deserve a roofer who treats every home like their own. From the historic neighborhoods of Trinity Park to the growing communities of Southpoint, we have earned our reputation by showing up on time, communicating honestly, and delivering craftsmanship that holds up long after the job is done. When your roof needs attention, we are the local team your neighbors already trust.'}
            </p>
